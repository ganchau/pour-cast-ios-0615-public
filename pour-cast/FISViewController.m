...
- (void)viewDidLoad {
    ...
    [ForcastAPIClient getForecastForCoordinate:CLLocationCoordinate2DMake(37.8267, -122.423)
                                    Completion:^(NSArray *dailyForecastModels) {
                                        
                                        NSArray *dayViews = @[ self.day1View,
                                                               self.day2View,
                                                               self.day3View,
                                                               self.day4View,
                                                               self.day5View ];
